...
#
#  $ bin/test -s inwi.digitab -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src inwi.digitab.testing.INWI_DIGITAB_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/inwi/digitab/tests/robot/test_example.robot
#
