# -*- coding: utf-8 -*-
from inwi.digitab.interfaces import IInwiDigitabLayer
from inwi.digitab.testing import INWI_DIGITAB_FUNCTIONAL_TESTING
from inwi.digitab.testing import INWI_DIGITAB_INTEGRATION_TESTING
...
class ViewletIntegrationTest(unittest.TestCase):
    ...
    def test_ruleml_viewlet_is_registered(self):
        ...
        manager.update()
        my_viewlet = [v for v in manager.viewlets if v.__name__ == 'ruleml-viewlet']  # NOQA: E501
        self.assertEqual(len(my_viewlet), 1)

    # XXX would be nice to have this test working:
    # def test_ruleml_viewlet_is_not_available_on_newsitem(self):
...
class ViewletFunctionalTest(unittest.TestCase):
    ...
    layer = INWI_DIGITAB_FUNCTIONAL_TESTING
